...
<head>
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50 bg-cover bg-no-repeat bg-fixed min-h-screen flex flex-col" style="background-image: url('{{ asset('storage/images/baltic.webp') }}')">
